...
#SBATCH --job-name=mapk_cascade  # Sets the job name
#SBATCH --output=/home/er636027/run/results/mapk_cascadeout.txt     # redirects stdout and stderr to stdout.txt
...
python3 ../scripts/run.py -t stationary -r results -f mapk_cascade.json
