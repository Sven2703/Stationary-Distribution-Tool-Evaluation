...
#SBATCH --job-name=lumbroso  # Sets the job name
#SBATCH --output=/home/er636027/run/results/lumbrosoout.txt     # redirects stdout and stderr to stdout.txt
...
python3 ../scripts/run.py -t stationary -r results -f lumbroso.json
