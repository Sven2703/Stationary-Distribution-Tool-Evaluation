...
#SBATCH --job-name=oscillators  # Sets the job name
#SBATCH --output=/home/er636027/run/results/oscillatorsout.txt     # redirects stdout and stderr to stdout.txt
...
python3 ../scripts/run.py -t stationary -r results -f oscillators.json
