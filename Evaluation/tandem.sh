...
#SBATCH --job-name=tandem  # Sets the job name
#SBATCH --output=/home/er636027/run/results/tandemout.txt     # redirects stdout and stderr to stdout.txt
...
python3 ../scripts/run.py -t stationary -r results -f tandem.json
