...
#SBATCH --job-name=leader-sync  # Sets the job name
#SBATCH --output=/home/er636027/run/results/leader-syncout.txt     # redirects stdout and stderr to stdout.txt
...
python3 ../scripts/run.py -t stationary -r results -f leader-sync.json
