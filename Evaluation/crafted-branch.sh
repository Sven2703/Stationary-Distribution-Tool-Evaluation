...
#SBATCH --job-name=crafted-branch  # Sets the job name
#SBATCH --output=/home/er636027/run/results/crafted-branchout.txt     # redirects stdout and stderr to stdout.txt
...
python3 ../scripts/run.py -t stationary -r results -f crafted-branch.json
