...
#SBATCH --job-name=toggle-switch  # Sets the job name
#SBATCH --output=/home/er636027/run/results/toggle-switchout.txt     # redirects stdout and stderr to stdout.txt
...
python3 ../scripts/run.py -t stationary -r results -f toggle-switch.json
