...
#SBATCH --job-name=egl  # Sets the job name
#SBATCH --output=/home/er636027/run/results/eglout.txt     # redirects stdout and stderr to stdout.txt
...
python3 ../scripts/run.py -t stationary -r results -f egl.json
