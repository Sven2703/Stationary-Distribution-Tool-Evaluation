...
#SBATCH --job-name=polling  # Sets the job name
#SBATCH --output=/home/er636027/run/results/pollingout.txt     # redirects stdout and stderr to stdout.txt
...
python3 ../scripts/run.py -t stationary -r results -f polling.json
