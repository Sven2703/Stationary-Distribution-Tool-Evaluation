...
#SBATCH --job-name=prism  # Sets the job name
#SBATCH --output=/home/er636027/run/results/prismout.txt     # redirects stdout and stderr to stdout.txt
...
python3 ../scripts/run.py -t stationary -r results -f prism3.json
