...
#SBATCH --job-name=crafted-loop  # Sets the job name
#SBATCH --output=/home/er636027/run/results/crafted-loopout.txt     # redirects stdout and stderr to stdout.txt
...
python3 ../scripts/run.py -t stationary -r results -f crafted-loop.json
